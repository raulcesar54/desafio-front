...
const h = (_param)=>{
    ...
    return /* @__PURE__ */ c("input", _object_spread_props(_object_spread({}, o), {
        inputMode: "numeric",
        pattern: "[0-9]*",
        onInput: (e)=>{
    ...
    return /* @__PURE__ */ c(T, _object_spread_props(_object_spread({}, f, I), {
        inputComponent: h,
...
export { h as IntegerInput, C as default };
