...
const m = (_param)=>{
    var { color: r, size: t = 24 } = _param, o = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const h = a(), l = r !== null && r !== void 0 ? r : h ? i.colors.inverse : i.colors.neutralHigh, { skinName: c } = s();
    ...
    })) : c.match(/^o2/i) ? /* @__PURE__ */ n("svg", _object_spread_props(_object_spread({
        width: t,
        height: t,
        viewBox: "0 0 24 24",
        role: "presentation"
