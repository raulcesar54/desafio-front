...
const v = (_param)=>{
    ...
    const h = n(), t = r !== null && r !== void 0 ? r : h ? e.colors.inverse : e.colors.neutralHigh, { skinName: a } = i();
    return a.match(/^o2-new/i) ? /* @__PURE__ */ s("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : a.match(/^o2/i) ? /* @__PURE__ */ s("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
