...
const m = (_param)=>{
    var { color: c, size: t = 24 } = _param, i = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const h = s(), a = c !== null && c !== void 0 ? c : h ? r.colors.inverse : r.colors.neutralHigh, { skinName: l } = n();
    return l.match(/^vivo-new/i) ? /* @__PURE__ */ o("svg", _object_spread_props(_object_spread({
        width: t,
        height: t,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : l.match(/^o2-new/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: t,
        height: t,
        viewBox: "0 0 24 24",
        role: "presentation"
