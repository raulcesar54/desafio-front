...
const h = (_param)=>{
    ...
    const r = s(), c = l !== null && l !== void 0 ? l : r ? i.colors.inverse : i.colors.neutralHigh, { skinName: a } = n();
    return a.match(/^vivo-new/i) ? /* @__PURE__ */ o("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
