...
const d = (_param)=>{
    ...
    const n = h(), r = l !== null && l !== void 0 ? l : n ? s.colors.inverse : s.colors.neutralHigh, { skinName: c } = a();
    return c.match(/^o2-new/i) ? /* @__PURE__ */ i("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : c.match(/^o2/i) ? /* @__PURE__ */ i("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
