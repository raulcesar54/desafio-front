...
const W = (param)=>{
    ...
    const f = n.useRef(!0), [i, E] = n.useState(k), [l, I] = n.useState(k), [w, m] = n.useState("filling"), [V, y] = n.useState({}), c = n.useRef(/* @__PURE__ */ new Map()), d = n.useRef(null), { texts: g } = A(), v = _(x);
    n.useEffect(()=>(f.current = !0, ()=>{
            f.current = !1;
        }), []);
    const j = n.useCallback((e, param)=>{
