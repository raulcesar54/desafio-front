...
const i = (_param)=>{
    var { color: s, size: c = 24 } = _param, l = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const o = (0, _themevariantcontext.useIsInverseVariant)(), e = s !== null && s !== void 0 ? s : o ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: r } = (0, _hooks.useTheme)();
