...
const l = (_param)=>{
    var { color: m, size: a = 24 } = _param, s = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const r = (0, _themevariantcontext.useIsInverseVariant)(), t = m !== null && m !== void 0 ? m : r ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh;
