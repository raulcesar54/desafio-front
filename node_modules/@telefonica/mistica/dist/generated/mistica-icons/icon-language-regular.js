...
const s = (_param)=>{
    var { color: l, size: a = 24 } = _param, m = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const t = (0, _themevariantcontext.useIsInverseVariant)(), c = l !== null && l !== void 0 ? l : t ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: h } = (0, _hooks.useTheme)();
